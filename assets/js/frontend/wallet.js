...
export function initWallet() {
	...
	function renderWallets( wallets, defaultWalletId ) {
		...
		wallets.forEach( function ( wallet ) {
			const actionsHtml = '<button type="button" class="beruang-btn beruang-btn--icon beruang-btn--primary beruang-action-edit" title="' + escapeHtml( i18n.edit || 'Edit' ) + '" aria-label="' + escapeHtml( i18n.edit || 'Edit' ) + '">' + editIcon + '</button>' +
				'<button type="button" class="beruang-btn beruang-btn--icon beruang-btn--danger beruang-action-delete" title="' + escapeHtml( i18n.delete || 'Delete' ) + '" aria-label="' + escapeHtml( i18n.delete || 'Delete' ) + '">' + deleteIcon + '</button>';
